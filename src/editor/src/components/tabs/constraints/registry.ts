...
export interface ConstraintEntry {
  ...
  createCard: (container: HTMLElement, uuid: EConstraintUuid) => void;
}
...
export const CONSTRAINT_REGISTRY: readonly ConstraintEntry[] = [
  {
    ...
    createCard: (container, uuid) => new EAspectConstraintCard(container, uuid),
  },
  {
    ...
    createCard: (container, uuid) => new EHorizontalDistanceConstraintCard(container, uuid),
  },
  {
    ...
    createCard: (container, uuid) => new EVerticalDistanceConstraintCard(container, uuid),
  },
  {
    ...
    createCard: (container, uuid) => new EHorizontalProportionConstraintCard(container, uuid),
  },
  {
    ...
    createCard: (container, uuid) => new EVerticalProportionConstraintCard(container, uuid),
  },
  {
    ...
    createCard: (container, uuid) => new EHorizontalSizeConstraintCard(container, uuid),
  },
  {
    label: "Size Vertical",
    type: EConstraintType.SIZE_VERTICAL,
    createBuilder: (container) => new ESizeVerticalConstraintBuilder(container),
    createCard: (container, uuid) => new EVerticalSizeConstraintCard(container, uuid),
  },
];
